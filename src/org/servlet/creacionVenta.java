...
@WebServlet(urlPatterns = { "/creacionVenta" })
public class creacionVenta extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       Ventas nArticulo = new Ventas(0,codigo, articulo,cantidad, costo);
       ...
       if (errorString == null) {
           try {
               DBUtils.insertVenta(conn, nArticulo);
       ...
       if (errorString != null) {
           RequestDispatcher dispatcher = request.getServletContext()
                   .getRequestDispatcher("/WEB-INF/views/crearVenta.jsp");
       ...
       // Redirect to the product listing page.            
           ...
           response.sendRedirect(request.getContextPath() + "/crearVenta");
       }
