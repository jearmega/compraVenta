...
@WebServlet(urlPatterns = { "/editarArticulo" })
public class editarArticulo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Articulos product = null;
 
        String errorString = null;
 
        try {
        	product = DBUtils.findProduct(conn, codigo);
        ...
        if (errorString != null && product == null) {
            response.sendRedirect(request.getServletPath() + "/listaArticulos");
            return;
        }
